...
s0.rmse <- compute_rmse(pred_s0, s0.true.ra)
...
# ------------------------------------------------------------------------------------------------
# Make plots of z0, A, WP, s0, A0 RMSE at each exposure level (similar to bias plots)
# Hold off on this for now. Just going to present results as a table.

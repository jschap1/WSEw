#' Nonlinear Slope Break Fit (multi)
#' 
...
#' @export
#' @details Uses multiple guesses for the initial parameters and chooses the best fit

fit_nlsb_try_multi <- function(WSEw, h = 10, maxiter = 100)
{
